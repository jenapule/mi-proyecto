<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Login_Admin.aspx.cs" Inherits="Login_Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
                    <asp:ImageButton ID="ImageButton5" runat="server" 
                        ImageUrl="~/Botones/Boton_Admin.png" onclick="ImageButton5_Click" />
                </p>
    <p>
                    &nbsp;</p>
    <table class="style6">
...
&nbsp;&nbsp;&nbsp;
                <asp:ImageButton ID="ImageButton4" runat="server" 
                    ImageUrl="~/Botones/Boton_Limpiar.png" onclick="ImageButton4_Click1" />
    </p>
    <p>
            &nbsp;</p>
    </asp:Content>
