<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Generar_Reporte_Instructor.aspx.cs" Inherits="Generar_Reporte_Instructor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table align="center" class="style6">
        ...
        <tr>
            ...
            <td class="style2">
&nbsp;<asp:Label ID="Label1" runat="server" ForeColor="Black" Text="Fecha Inicio:" 
...
&nbsp;<asp:ImageButton ID="ImageButton7" runat="server" Height="20px" 
                    ...
                    Width="20px" />
                <br />
                <asp:Label ID="Label2" runat="server" ForeColor="Black" Text="Fecha Fin:" 
                    style="font-family: Arial, Helvetica, sans-serif; font-size: small"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
